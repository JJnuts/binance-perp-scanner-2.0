...
from .table_help import BEST_SETUPS_COLUMN_HELP, HTF_EXPANSION_COLUMN_HELP, LTF_IGNITION_COLUMN_HELP
...
def _show_ltf_ignition_table(df: pd.DataFrame):
    ...
    st.dataframe(
        ...
        hide_index=True,
        column_config={
            "symbol": st.column_config.TextColumn("Symbol", help=LTF_IGNITION_COLUMN_HELP["symbol"]),
            "ignition_state": st.column_config.TextColumn("State", help=LTF_IGNITION_COLUMN_HELP["ignition_state"]),
            "ignition_tf": st.column_config.TextColumn("TF", help=LTF_IGNITION_COLUMN_HELP["ignition_tf"]),
            "ltf_ignition_score": st.column_config.NumberColumn("Ignition", format="%.1f", help=LTF_IGNITION_COLUMN_HELP["ltf_ignition_score"]),
            "conviction_net": st.column_config.NumberColumn("Conviction", format="%.2f", help=LTF_IGNITION_COLUMN_HELP["conviction_net"]),
            "atr_percentile": st.column_config.NumberColumn("ATR %ile", format="%.1f", help=LTF_IGNITION_COLUMN_HELP["atr_percentile"]),
            "atr_roc": st.column_config.TextColumn("ATR ROC", help=LTF_IGNITION_COLUMN_HELP["atr_roc"]),
            "atr_compression_score": st.column_config.NumberColumn("Compression", format="%.1f", help=LTF_IGNITION_COLUMN_HELP["atr_compression_score"]),
            "atr_expansion_score": st.column_config.NumberColumn("Expansion", format="%.1f", help=LTF_IGNITION_COLUMN_HELP["atr_expansion_score"]),
            "volume_zscore": st.column_config.NumberColumn("Vol Z", format="%.2f", help=LTF_IGNITION_COLUMN_HELP["volume_zscore"]),
            "oi_zscore": st.column_config.NumberColumn("OI Z", format="%.2f", help=LTF_IGNITION_COLUMN_HELP["oi_zscore"]),
            "taker_imbalance": st.column_config.NumberColumn("Taker", format="%.2f", help=LTF_IGNITION_COLUMN_HELP["taker_imbalance"]),
            "cvd_3bar_slope": st.column_config.NumberColumn("CVD 3", format="%.0f", help=LTF_IGNITION_COLUMN_HELP["cvd_3bar_slope"]),
            "basis_bp": st.column_config.NumberColumn("Basis bp", format="%.1f", help=LTF_IGNITION_COLUMN_HELP["basis_bp"]),
            "basis_delta_3bar_bp": st.column_config.NumberColumn("Basis d3", format="%.1f", help=LTF_IGNITION_COLUMN_HELP["basis_delta_3bar_bp"]),
            "price_distance_from_vwap_atr": st.column_config.NumberColumn("VWAP Dist ATR", format="%.2f", help=LTF_IGNITION_COLUMN_HELP["price_distance_from_vwap_atr"]),
            "breakout_distance_atr": st.column_config.NumberColumn("Breakout ATR", format="%.2f", help=LTF_IGNITION_COLUMN_HELP["breakout_distance_atr"]),
            "break_hold_confirmed": st.column_config.CheckboxColumn("Hold", help=LTF_IGNITION_COLUMN_HELP["break_hold_confirmed"]),
            "rs_vs_btc": st.column_config.TextColumn("RS BTC", help=LTF_IGNITION_COLUMN_HELP["rs_vs_btc"]),
            "rs_vs_eth": st.column_config.TextColumn("RS ETH", help=LTF_IGNITION_COLUMN_HELP["rs_vs_eth"]),
            "compression_recent_bars": st.column_config.NumberColumn("Comp Bars", format="%d", help=LTF_IGNITION_COLUMN_HELP["compression_recent_bars"]),
            "bars_since_trigger": st.column_config.NumberColumn("Age", format="%d", help=LTF_IGNITION_COLUMN_HELP["bars_since_trigger"]),
            "tf_alignment_score": st.column_config.NumberColumn("TF Align", format="%d", help=LTF_IGNITION_COLUMN_HELP["tf_alignment_score"]),
            "ignition_score_5m": st.column_config.NumberColumn("5m", format="%.1f", help=LTF_IGNITION_COLUMN_HELP["ignition_score_5m"]),
            "ignition_score_15m": st.column_config.NumberColumn("15m", format="%.1f", help=LTF_IGNITION_COLUMN_HELP["ignition_score_15m"]),
            "ignition_score_1h": st.column_config.NumberColumn("1h", format="%.1f", help=LTF_IGNITION_COLUMN_HELP["ignition_score_1h"]),
        },
    )
def _show_htf_expansion_table(df: pd.DataFrame):
    ...
    st.dataframe(
        ...
        hide_index=True,
        column_config={
            "symbol": st.column_config.TextColumn("Symbol", help=HTF_EXPANSION_COLUMN_HELP["symbol"]),
            "htf_expansion_direction": st.column_config.TextColumn("State", help=HTF_EXPANSION_COLUMN_HELP["htf_expansion_direction"]),
            "htf_expansion_score": st.column_config.NumberColumn("Expansion", format="%.1f", help=HTF_EXPANSION_COLUMN_HELP["htf_expansion_score"]),
            "htf_atr_percentile": st.column_config.NumberColumn("ATR %ile", format="%.1f", help=HTF_EXPANSION_COLUMN_HELP["htf_atr_percentile"]),
            "htf_atr_roc": st.column_config.TextColumn("ATR ROC", help=HTF_EXPANSION_COLUMN_HELP["htf_atr_roc"]),
            "htf_atr_compression_score": st.column_config.NumberColumn("Compression", format="%.1f", help=HTF_EXPANSION_COLUMN_HELP["htf_atr_compression_score"]),
            "htf_atr_expansion_score": st.column_config.NumberColumn("ATR Expand", format="%.1f", help=HTF_EXPANSION_COLUMN_HELP["htf_atr_expansion_score"]),
            "htf_breakout_distance_atr": st.column_config.NumberColumn("Breakout ATR", format="%.2f", help=HTF_EXPANSION_COLUMN_HELP["htf_breakout_distance_atr"]),
            "htf_range_width_atr": st.column_config.NumberColumn("Range ATR", format="%.2f", help=HTF_EXPANSION_COLUMN_HELP["htf_range_width_atr"]),
            "daily_structure_score": st.column_config.NumberColumn("Daily Struct", format="%.1f", help=HTF_EXPANSION_COLUMN_HELP["daily_structure_score"]),
            "daily_atr_percentile": st.column_config.NumberColumn("D ATR %ile", format="%.1f", help=HTF_EXPANSION_COLUMN_HELP["daily_atr_percentile"]),
            "daily_volume_ratio": st.column_config.NumberColumn("D Vol", format="%.2f", help=HTF_EXPANSION_COLUMN_HELP["daily_volume_ratio"]),
            "daily_volume_persistence_days": st.column_config.NumberColumn("Vol Days", format="%d", help=HTF_EXPANSION_COLUMN_HELP["daily_volume_persistence_days"]),
            "daily_oi_persistence_days": st.column_config.NumberColumn("OI Days", format="%d", help=HTF_EXPANSION_COLUMN_HELP["daily_oi_persistence_days"]),
            "daily_swing_high": st.column_config.NumberColumn("Swing High", format="%.4g", help=HTF_EXPANSION_COLUMN_HELP["daily_swing_high"]),
            "daily_swing_low": st.column_config.NumberColumn("Swing Low", format="%.4g", help=HTF_EXPANSION_COLUMN_HELP["daily_swing_low"]),
            "daily_long_confirmed": st.column_config.CheckboxColumn("D Long", help=HTF_EXPANSION_COLUMN_HELP["daily_long_confirmed"]),
            "daily_short_confirmed": st.column_config.CheckboxColumn("D Short", help=HTF_EXPANSION_COLUMN_HELP["daily_short_confirmed"]),
            "btc_daily_regime": st.column_config.TextColumn("BTC Regime", help=HTF_EXPANSION_COLUMN_HELP["btc_daily_regime"]),
            "btc_daily_regime_score": st.column_config.NumberColumn("BTC Score", format="%.1f", help=HTF_EXPANSION_COLUMN_HELP["btc_daily_regime_score"]),
            "htf_momentum_score": st.column_config.NumberColumn("HTF Momentum", format="%.1f", help=HTF_EXPANSION_COLUMN_HELP["htf_momentum_score"]),
            "htf_setup_score": st.column_config.NumberColumn("HTF Setup", format="%.1f", help=HTF_EXPANSION_COLUMN_HELP["htf_setup_score"]),
            "htf_relative_strength_score": st.column_config.NumberColumn("HTF RS", format="%.1f", help=HTF_EXPANSION_COLUMN_HELP["htf_relative_strength_score"]),
            "volume_score": st.column_config.NumberColumn("Vol Score", format="%.1f", help=HTF_EXPANSION_COLUMN_HELP["volume_score"]),
            "oi_score": st.column_config.NumberColumn("OI Score", format="%.1f", help=HTF_EXPANSION_COLUMN_HELP["oi_score"]),
            "rs_24h": st.column_config.TextColumn("RS 24H", help=HTF_EXPANSION_COLUMN_HELP["rs_24h"]),
            "rs_72h": st.column_config.TextColumn("RS 72H", help=HTF_EXPANSION_COLUMN_HELP["rs_72h"]),
        },
    )
def _show_best_setups_table(df: pd.DataFrame):
    ...
    st.dataframe(
        ...
        hide_index=True,
        column_config={
            "symbol": st.column_config.TextColumn("Symbol", help=BEST_SETUPS_COLUMN_HELP["symbol"]),
            "best_setup_state": st.column_config.TextColumn("Best Setup", help=BEST_SETUPS_COLUMN_HELP["best_setup_state"]),
            "best_setup_score": st.column_config.NumberColumn("Score", format="%.1f", help=BEST_SETUPS_COLUMN_HELP["best_setup_score"]),
            "ignition_state": st.column_config.TextColumn("LTF State", help=BEST_SETUPS_COLUMN_HELP["ignition_state"]),
            "ignition_tf": st.column_config.TextColumn("TF", help=BEST_SETUPS_COLUMN_HELP["ignition_tf"]),
            "ltf_ignition_score": st.column_config.NumberColumn("LTF Ignition", format="%.1f", help=BEST_SETUPS_COLUMN_HELP["ltf_ignition_score"]),
            "htf_expansion_direction": st.column_config.TextColumn("HTF State", help=BEST_SETUPS_COLUMN_HELP["htf_expansion_direction"]),
            "htf_expansion_score": st.column_config.NumberColumn("HTF Expansion", format="%.1f", help=BEST_SETUPS_COLUMN_HELP["htf_expansion_score"]),
            "daily_structure_score": st.column_config.NumberColumn("Daily Struct", format="%.1f", help=BEST_SETUPS_COLUMN_HELP["daily_structure_score"]),
            "daily_volume_persistence_days": st.column_config.NumberColumn("Vol Days", format="%d", help=BEST_SETUPS_COLUMN_HELP["daily_volume_persistence_days"]),
            "daily_oi_persistence_days": st.column_config.NumberColumn("OI Days", format="%d", help=BEST_SETUPS_COLUMN_HELP["daily_oi_persistence_days"]),
            "btc_daily_regime": st.column_config.TextColumn("BTC Regime", help=BEST_SETUPS_COLUMN_HELP["btc_daily_regime"]),
            "alignment_score": st.column_config.NumberColumn("Align", format="%.1f", help=BEST_SETUPS_COLUMN_HELP["alignment_score"]),
            "tf_alignment_score": st.column_config.NumberColumn("TF Align", format="%d", help=BEST_SETUPS_COLUMN_HELP["tf_alignment_score"]),
            "bars_since_trigger": st.column_config.NumberColumn("Age", format="%d", help=BEST_SETUPS_COLUMN_HELP["bars_since_trigger"]),
            "volume_zscore": st.column_config.NumberColumn("Vol Z", format="%.2f", help=BEST_SETUPS_COLUMN_HELP["volume_zscore"]),
            "oi_zscore": st.column_config.NumberColumn("OI Z", format="%.2f", help=BEST_SETUPS_COLUMN_HELP["oi_zscore"]),
            "taker_imbalance": st.column_config.NumberColumn("Taker", format="%.2f", help=BEST_SETUPS_COLUMN_HELP["taker_imbalance"]),
            "cvd_3bar_slope": st.column_config.NumberColumn("CVD 3", format="%.0f", help=BEST_SETUPS_COLUMN_HELP["cvd_3bar_slope"]),
            "basis_bp": st.column_config.NumberColumn("Basis bp", format="%.1f", help=BEST_SETUPS_COLUMN_HELP["basis_bp"]),
            "basis_delta_3bar_bp": st.column_config.NumberColumn("Basis d3", format="%.1f", help=BEST_SETUPS_COLUMN_HELP["basis_delta_3bar_bp"]),
            "atr_percentile": st.column_config.NumberColumn("ATR %ile", format="%.1f", help=BEST_SETUPS_COLUMN_HELP["atr_percentile"]),
            "atr_roc": st.column_config.TextColumn("ATR ROC", help=BEST_SETUPS_COLUMN_HELP["atr_roc"]),
            "breakout_distance_atr": st.column_config.NumberColumn("Breakout ATR", format="%.2f", help=BEST_SETUPS_COLUMN_HELP["breakout_distance_atr"]),
            "rs_vs_btc": st.column_config.TextColumn("RS BTC", help=BEST_SETUPS_COLUMN_HELP["rs_vs_btc"]),
            "rs_vs_eth": st.column_config.TextColumn("RS ETH", help=BEST_SETUPS_COLUMN_HELP["rs_vs_eth"]),
        },
    )
